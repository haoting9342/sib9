 ...
 * The function return 0 if success, others if fail.
 */
extern int ch36x_read_io_byte(int fd, unsigned long ioaddr, unsigned long * obyte);
 ...
 * The function return 0 if success, others if fail.
 */
extern int ch36x_write_io_byte(int fd, unsigned long ioaddr,  unsigned long ibyte);
